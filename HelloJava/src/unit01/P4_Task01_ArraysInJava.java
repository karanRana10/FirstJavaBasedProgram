...
public class P4_Task01_ArraysInJava {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
       /*
        * -normally, an array is collection of similar type of element which has contiguous memory location.
        ...
        */
		...
		for(int i=0;i<array1.length;i++)//length is the property of f an array
			array1[i]=i;
		...
		System.out.println(array5.toString());
		 //array indexOutOfBoundsExeption
		int arr[] = {50,60,70,80};
